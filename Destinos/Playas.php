	...
	<div class="container logo-nav-container">
		...
		<nav class="navigation">
			<ul>
				...
				<li><a href="../reseñas.php">Resennas</a></li>
	...
	<table class="contenido-opciones">
		<tr>
			...
			<div class="contenido-filtro">
				...
				<a href="Cascadas.php">Cascadas</a><br>
				<a href="Reservas.php">Reservas naturales</a><br>
				<a href="Grutas.php">Grutas</a><br>
				<strong class="ubicacion">Playas</strong><br>
			...
			<td class="lugares"> 
				<div class="lugar">
					<a href=""> <img src="../IMG/Banners/BProximamente.png" alt="" class="Fotolugar"> </a>		
				</div>					
			</td>			
		</tr>
		<tr>
